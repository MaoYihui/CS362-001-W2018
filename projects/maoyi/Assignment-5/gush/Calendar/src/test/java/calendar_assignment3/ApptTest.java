...
*/
	...
	// assertions
		 ...
		 System.out.println("---------------------------------------------------------------------------");
		 System.out.println("The expected return value of appt.toString() should be \"\t2/15/2018 at 9:30am ,Birthday Party, This is my birthday party.\\n\", , but the" +
				 "actual value is"+appt.toString());
		 System.out.println("---------------------------------------------------------------------------");
		...
		// assertEquals("	2/15/2018 at 11:30pm ,Birthday Party, This is my birthday party.\n", appt_1.toString());
		 System.out.println("---------------------------------------------------------------------------");
		 System.out.println("The expected return value of appt.toString() should be \"\t2/15/2018 at 11:30am ,Birthday Party, This is my birthday party.\\n\", , but the" +
				 "actual value is"+appt.toString());
		 System.out.println("---------------------------------------------------------------------------");
		...
		// assertFalse(appt_11.getValid());
		 System.out.println("---------------------------------------------------------------------------");
		 System.out.println("The expected return value of app_11.getValid() should be false, but the actual value is " +
				 appt_11.getValid()) ;

		 System.out.println("My team mate change if(startHour<0||startHour>23) to if(startHour<0&&startHour>23) ");
		 System.out.println("---------------------------------------------------------------------------");
       ...
       // appt_11.setStartHour(-1 );
		...
		// appt_11.setStartHour(24 );
		 ...
		 appt_11.setStartMinute(-1 );
         assertNotEquals(null, appt_11.toString());
   ...
   @Test
	...
	public void test04()  throws Throwable {
      ...
      int startMinute_2=61;
		...
		Appt appt_9 = new Appt(start_hour_0,
				11,
				12 ,
				3 ,
				1989 ,
			...
			//assertFalse(appt_9.getValid());
		System.out.println("---------------------------------------------------------------------------");
		System.out.println("The expected return value of appt_9.getValid() should be false, but the" +
				 "actual value is"+appt_9.getValid() );
		System.out.println("---------------------------------------------------------------------------");
