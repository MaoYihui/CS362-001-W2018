	  ...
	  public void radnomtest()  throws Throwable  {
		...
		try{ 
			for (int iteration = 0; elapsed < TestTimeout; iteration++) {
				...
				//assertEquals(startHour_1,appt_1.getStartHour());
				//assertEquals(startMinute_1, appt_1.getStartMinute());
				//assertEquals(startDay_1, appt_1.getStartDay());
				//assertEquals(startYear_1, appt_1.getStartYear());
				//assertEquals(startMonth_1, appt_1.getStartMonth());
